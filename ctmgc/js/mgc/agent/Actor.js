...
mgc.agent.Actor = CT.Class({
	"CLASSNAME": "mgc.agent.Actor",
	"_": {
		"cb": {
	...
	"postInit": function() {
		CT.pubsub.set_reconnect(core.config.ctmgc.ws.reconnect);
		CT.pubsub.connect(core.config.ctmgc.ws.host, core.config.ctmgc.ws.port, this.name);
	},
